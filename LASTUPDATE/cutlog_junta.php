...
<script type="text/javascript">
    $(document).ready(function(){
        $(".add-row").click(function(){
			...
			var tiempo=$("#hms").val();
            var markup = "<tr><td><input type='checkbox' name='record'></td><td>" + id + "</td><td>" + job + "</td><td>" + heat + "</td><td>" + probeta + "</td><td>" + line + "</td><td>" + line + "</td><td><input type='button' class='btn btn-primary'name='phaseA'value='Phase A' id='button'></td><td><input type='button'class='btn btn-warning' name='phaseB'value='Phase B'></td><td><input type='button' class='btn btn-success' name='phaseC'value='Phase C'></td><td><input type='button' class='btn btn-danger'name='phaseD'value='Phase D'></td><td>" + line + "</td><td><div id='hms'>00:00:10</div></td></tr>";<!-- HERE IM PRINTING THE TIMER BUT ONLY WORKS ONE TIME-->
